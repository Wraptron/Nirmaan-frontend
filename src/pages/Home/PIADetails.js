...
const PIADetails = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      toast.error(getErrorMessage(err, "Failed to load PIA details."));
    }
  };
  useEffect(() => {
    fetchData();
            ...
            <div className="border bg-white">
              <div className="flex px-2 pt-6 items-center">
                ...
                <div className=" text-sm text-[#808080]">
                  Dashboard {">"} PIA Details
                </div>
              </div>
              <div className="font-bold text-lg px-5 pt-3">PIA</div>
              {/* Search and Add */}
                  ...
                  <table className="min-w-full text-sm text-left border-collapse">
                    <thead className="sticky top-0 bg-white z-10">
                      <tr className="border-b border-dotted">
                        ...
                        <th className="px-4 py-2">PIA Status</th>
                      </tr>
                    </thead>
                    <tbody>
