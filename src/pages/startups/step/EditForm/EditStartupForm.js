...
// if (
//   formData.startup_status === "Active" &&
//   (formData.program === "Dropped out" || formData.program.toLowerCase() === "dropped out")
// ) {
//   toast.error("You cannot set status to 'Active' when the program is 'Dropped out'.");
//   return;
// }
...
const EditStartupForm = ({ initialData, onClose, onSubmit }) => {
  ...
  const isStatusFieldVisible = () => {
    const program = formData.program?.toLowerCase();
    return program === "akshar" || program === "pratham";
  };
