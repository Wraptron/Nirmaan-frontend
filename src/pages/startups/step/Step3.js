...
const Step3 = ({formData, handleChange,selectedProgram}) => {
  const [errors, setErrors] = useState({});

  const isDropped=selectedProgram === "Dropped out"

  // Validation functions for each field
  const validateFounderName = (value) => {
    if(selectedProgram !== "Dropped out"){
    if (!value) return "Founder name is required";
    }
    if (value.length < 2) return "Founder name must be at least 2 characters";
    if (!/^[a-zA-Z\s]+$/.test(value)) return "Founder name can only contain letters and spaces";
  ...
  // Handle field validation on change
  const validators = {
    FounderName:validateFounderName,
    FounderEmail:validateFounderEmail,
    FounderNumber:validateFounderNumber,
    validateFounderGender: validateFounderGender,
    FounderStudentId :validateFounderStudentId,
    AcademicBackground:validateAcademicBackground
  }
  const handleFieldChange = (e) => {
    const { name, value } = e.target;
...
const isFormValid = () => {
  ...
  return (
    <div className="grid grid-cols-2 gap-5 mt-9 px-7">
        <div>
          {isDropped ? <div>Founder Name </div>: <div>Founder Name <span className="text-red-500">*</span></div>}
            <div className="mt-1">
              <input 
                type="text" 
                onChange={handleFieldChange} 
        ...
        <div>
          {isDropped ?  <div>Email Address</div> : <div>Email Address <span className="text-red-500">*</span></div>}
            <div className="mt-1">
              <input 
                type="email" 
                onChange={handleFieldChange} 
        ...
        <div>
          {isDropped ?  <div>Contact Number </div> : <div>Contact Number <span className="text-red-500">*</span></div>}
        ...
        <div>
          {isDropped ?  <div>Gender</div> : <div>Gender <span className="text-red-500">*</span></div> }
        ...
        <div>
          {isDropped ?   <div>Student ID </div> :  <div>Student ID <span className="text-red-500">*</span></div>}
        ...
        {/* Academic Background Field */}
        <div>
          {isDropped ? <div>Academic Background </div> : <div>Academic Background <span className="text-red-500">*</span></div> }
